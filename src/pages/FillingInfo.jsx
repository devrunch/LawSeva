            ...
            <div className="w-full bg-white p-2 md:p-8 ">
                <div className="px-6 py-4 bg-white shadow-md container m-auto">
                    ...
                    <div>
                        ...
                        <div className=" mt-10 container m-auto flex justify-between items-center w-full  flex-wrap">
                            <div className="m-auto ">
                                <h2 className="text-xl font-bold mb-2">GST - the Goods and Services Tax</h2>
                                <p className="text-md mt-3 md:w-4/5">
                            ...
                            <div className=" md:w-4/12">
                                <img src={'https://lh7-us.googleusercontent.com/bm5L2zHvl-wELzgIhIowdejx2AaL_Qk99KuhmMTjjrI_jfXu_IcUcqCMdchn2ryNS9FSwVXCfhDYAlDluhHGTOnxERdYQ71u7VAUnn_QVewdpXj6jN-UwB5JjEXTE95Cdf5rEwTe4sjW4N6o8sHV5bc'} alt="" width={800} />
                            </div>
                        </div>
                        <div className="mt-10  container m-auto flex justify-between items-center w-full  flex-wrap-reverse ">
                            ...
                            <div className="m-auto ">
                                ...
                                <p className="text-md mt-3 ml-3 leading-10 md:w-4/5">
